...
void MoveCursorTo(int x, int y) { printf("\033[%d;%dH", y, x); }
void SetForgroundColor(TColor c) { printf("\033[3%cm", '0' + c); }
void SetBackgroundColor(TColor c) { printf("\033[4%cm", '0' + c); }
/*
