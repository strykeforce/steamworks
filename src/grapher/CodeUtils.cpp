...
double Random() { return (double)random() / RAND_MAX; }

double Hypot(double x, double y) { return sqrt(pow(x, 2) + pow(y, 2)); }

double ToDegrees(double rad) { return rad / M_PI * 180.0; }

double ToRadians(double rad) { return rad * M_PI / 180.0; }
