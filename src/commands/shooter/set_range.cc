...
bool SetRange::IsFinished() {
  // int elevation_error = std::abs(elevation_ -
  // Robot::shooter->GetElevation()); int speed_error = std::abs(speed_ -
  // Robot::shooter->GetSpeed()); return (elevation_error < kElevationGoodEnough
  // &&
