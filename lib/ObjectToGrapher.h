	...
	struct JerrysGrapher_DeviceList_Request			// Sent FROM Grapher (Begins Commication)
	{
	...
	struct JerrysGrapher_SubscriptionData			// Sent FROM Grapher
	{
		...
		byte Data[JERRYSGRAPHER_MAX_NUMBER_OF_DATAPOINTS][JERRYSGRAPHER_MAX_DATA_SIZE];
	};
