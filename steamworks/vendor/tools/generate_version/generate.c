...
int main(int argc, char** argv) {
  ...
  while ((c = getopt_long(argc, argv, "hM:m:p:b:a:P:D:T:iF:", long_options,
                          0)) != -1) {
    switch (c) {
      case 'h':
  ...
  printf(VERSION_H, prefix, prefix, prefix, major, prefix, minor, prefix, patch,
         prefix, build, prefix, meta, prefix, major, minor, patch, build, meta,
         prefix, datestr, prefix, timestr, prefix);
